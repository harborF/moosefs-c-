...
static struct fuse_lowlevel_ops mfs_meta_oper = {
    ...
    forget:NULL,
    getattr:mfs_meta_getattr,    setattr:mfs_meta_setattr,
    readlink:NULL,
    mknod:NULL,
    mkdir:NULL,
    ...
    link:NULL,
    open:mfs_meta_open,    read:mfs_meta_read,    write:mfs_meta_write,
    flush:NULL,
    release:mfs_meta_release,
    fsync:NULL,
    opendir:mfs_meta_opendir,    readdir:mfs_meta_readdir,    releasedir:mfs_meta_releasedir,    fsyncdir:NULL,
    statfs:mfs_meta_statfs,
    setxattr:NULL,    getxattr:NULL,    listxattr:NULL,    removexattr:NULL,
    access:NULL,
    create:NULL,
    getlk:NULL,    setlk:NULL,
    bmap:NULL,
    ioctl:NULL,
    poll:NULL,
    write_buf:NULL,
...
static struct fuse_lowlevel_ops mfs_oper = {
    ...
    lookup:mfs_lookup,
    forget:NULL,
    getattr:mfs_getattr,    setattr:mfs_setattr,
    ...
    rename:mfs_rename,
    link:mfs_link,
    open:mfs_open,    read:mfs_read,    write:mfs_write,
    flush:mfs_flush,
    release:mfs_release,
    fsync:mfs_fsync,
    opendir:mfs_opendir,    readdir:mfs_readdir,    releasedir:mfs_releasedir,    fsyncdir:NULL,
    statfs:mfs_statfs,
    setxattr:mfs_setxattr,    getxattr:mfs_getxattr,    listxattr:mfs_listxattr,    removexattr:mfs_removexattr,
    access:mfs_access,
    create:mfs_create,
    getlk:NULL,    setlk:NULL,
    bmap:NULL,
